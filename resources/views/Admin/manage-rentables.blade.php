        ...
        <table class="text-left p-1 border-collapse shadow-md w-fit">
            ...
            @forelse($rentables as $rentable)
                <tr class="odd:bg-stone-100 even:bg-stone-200">
                    ...
                    <td>
                        <button id="updateButton" value="{{$rentable->id }}" type="button" x-on:click="updating = !updating" class="w-full flex justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                    ...
                    <td>
                        <button id="deleteButton" value="{{$rentable->id }}" type="button" x-on:click="deleting = !deleting" class="w-full flex justify-center">
