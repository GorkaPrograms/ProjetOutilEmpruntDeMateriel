            ...
            <div class="col-1">
                <div class="w-full h-[350px] bg-white rounded-2xl">
                    @if ($rentable->image != null )
                        <img class="object-contain rounded-2xl w-full h-full shadow-xl p-4" src="{{ asset($rentable->image) }}">
                    @else
                        <img class="object-contain rounded-2xl w-full h-full shadow-xl p-4" src="{{ asset('default-img.jpg') }}">
                    @endif
                </div>
                <div class="flex flex-row justify-between mt-2">
                    ...
                    <form action="{{ route('cart.add-product') }}" method="post">
                        ...
                        <button class="flex flex-row text-gray-50 shadow-inner bg-logo-green p-1 rounded-md hover:bg-green-600 hover:scale-110 hover:cursor-pointer ease-in-out duration-200">
                            Ajouter au panier
